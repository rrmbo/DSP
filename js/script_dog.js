...
function genString(d) {
    return "translate (" + Math.random() * (width - 200) + 100 + "," + Math.random() * fullHeight + 100 + ") rotate(" + Math.random() * 360 + ") scale(" + d.expense / 50 + ")"
}
...
function drawPlot(data) {
    ...
    locations
        ...
        .html(`
        <path class="back-bun" style="fill: #f9b5ab;" d="M19.72,1.12C11.58,1.64,5.03,4.12,6.53,11.64c.72,3.6,3.75,6.7,7.37,8.67,3.61,1.97,7.77,2.96,11.89,3.75,19.24,3.71,39.46,3.66,57.72-1.6,5.73-1.65,11.41-3.9,15.35-7.81,2.64-2.62,4.35-6.64,2.08-9.7-1.69-2.28-4.98-3.2-8.01-3.69-16.55-2.68-33.15,2.01-49.86,1.14-4.66-.24-14.87-1.83-23.35-1.29Z"/>
        ...
        <path class="front-bun" style="fill: #f9b5ab;" d="M24.64,13.85c-8.14,.52-14.69,3-13.19,10.53,.72,3.6,3.75,6.7,7.37,8.67s7.77,2.96,11.89,3.75c19.24,3.71,39.46,3.66,57.72-1.6,5.73-1.65,11.41-3.9,15.35-7.81,2.64-2.62,4.35-6.64,2.08-9.7-1.69-2.28-4.98-3.2-8.01-3.69-16.55-2.68-33.15,2.01-49.86,1.14-4.66-.24-14.87-1.83-23.35-1.29Z"/>`)
