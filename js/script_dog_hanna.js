...
function genString(d) {
    return "translate (" + Math.random() * (width - 200) + 100 + "," + Math.random() * fullHeight + 100 + ") rotate(" + Math.random() * 360 + ") "
}
...
function drawPlot(data) {
    ...
    locations
        ...
        // .attr("transform", "translate (" + Math.random() * (width - 200) + 100 + "," + Math.random() * fullHeight + 100 + ") rotate(" + Math.random() * 360 + ") scale(" + (getExpenseValue).toString() + ")")
        .attr("transform", genString)
        .attr("viewBox", "0 0 300 300")
        .attr("width", getExpenseValue)
        .attr("height", getExpenseValue)
        .html(function(d) {
            return createHogs(d.expense)
        })
